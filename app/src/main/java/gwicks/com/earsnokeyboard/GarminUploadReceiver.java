 ...
 * Uploads the Garmin wearable files created to AWS, once a day
 *
 */


public class GarminUploadReceiver extends BroadcastReceiver {

    private static final String TAG = "GarminUploadReceiver";
    TransferUtility mTransferUtility;
    Encryption mEncryption;
    Context mContext;
    String encryptedPath;
    static String folder = "/GARMIN/";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.d(TAG, "onReceive: we have received the broadcast recveiver for Garmin Upload");

        GarminUpload();

    }

    public void GarminUpload(){
    ...
    public String Encrypt(String name, String path){
        ...
        try {
            ...
            path2 = mEncryption.encrypt(mFileName, mFilePath, "/GARMIN/");
