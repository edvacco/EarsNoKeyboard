package gwicks.com.earsnokeyboard.Garmin;
...
/* package */ class DeviceAdapter extends RecyclerView.Adapter<DeviceAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.mForgetDevice.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        holder.mDeviceConnectedStatus.setOnClickListener(new View.OnClickListener() {
            @Override
